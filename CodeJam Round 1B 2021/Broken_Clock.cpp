...
void solve(){
	ll a, b, c; cin >> a >> b >> c;
    double f = (a * 1.0 ) / (1.0 * 12 * powl(10, 10));
    double s = (b * 1.0 ) / (1.0 * 12 * powl(10, 10));
    double t = (c * 1.0 ) / (1.0 * 12 * powl(10, 10));
    double nano = f + s + t - (ll)(f + s + t);
    dbvar(f, s, t, nano);
    ll hour = f / 30;
    ll minute = (2 * s) / 60;
    ll second = (120 * t ) / (60 * 60);
    ll nanosecond = (nano) / (60 * 60);
